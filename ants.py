        ...
        if self.impostor is True:
            ...
            while current_place is not None:
                if current_place.ant:
                    if current_place.ant.container and current_place.ant.container not in self.lst_ants:
                        if current_place.ant.ant and current_place.ant.ant not in self.lst_ants:
                            current_place.ant.ant.damage *= 2
                            self.lst_ants.append(current_place.ant.ant)

                    if current_place.ant not in self.lst_ants:
                        current_place.ant.damage *= 2
                        self.lst_ants.append(current_place.ant)
